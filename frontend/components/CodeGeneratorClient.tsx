        ...
        <main className={`${showHistory ? 'lg:col-span-7' : 'lg:col-span-12'} space-y-4 sm:space-y-6`}>
          ...
          <div className="animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="flex-1 flex flex-col bg-slate-50 dark:bg-slate-900">
              <div className="p-4 bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm border-b border-slate-200 dark:border-slate-700 flex items-center justify-between shadow-sm">
                <div className="flex items-center space-x-3">
                  <h3 className="text-lg font-semibold text-slate-800 dark:text-white flex items-center">
                    <span className="mr-2">💻</span> Generated Code
                  </h3>
                  {generatedCode && (
                    <span className="px-3 py-1 text-xs font-semibold bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-md uppercase tracking-wide shadow-sm">
                      {language}
                    </span>
                  )}
                </div>
                <div className="flex items-center space-x-2">
                  {generatedCode && (
                    <button
                      onClick={handleCopy}
                      className="px-4 py-2 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all duration-200 transform hover:scale-105 flex items-center"
                      title="Copy code"
                    >
                      {copied ? (
                        <>
                  ...
                  <div className="h-full flex items-center justify-center">
                    <div className="text-center max-w-md">
                      ...
                      <p className="text-sm text-slate-500 dark:text-slate-400">
                        Enter your requirements above and click the generate button to create code instantly
                      </p>
                    </div>
                  </div>
                )}
